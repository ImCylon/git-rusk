...
mod tests {
    ...
    #[test]
    #[serial]
    fn test_run_verifies_totp_when_require_for_branch_switch_enabled() {
        let config = Config {
            totp: TotpConfig {
    ...
    #[test]
    #[serial]
    fn test_run_skips_totp_when_require_for_branch_switch_disabled() {
        let config = Config {
            totp: TotpConfig {
    ...
    #[test]
    #[serial]
    fn test_run_returns_error_on_invalid_totp_code() {
        let config = Config {
            totp: TotpConfig {
                require_for_branch_switch: true,
                ..Default::default()
